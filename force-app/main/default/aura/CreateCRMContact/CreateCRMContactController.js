        ...
        var action = component.get("c.getUserInfo");
                ...
                action.setCallback(this, function(response) {
                        ...
                        if (component.isValid() && state === "SUCCESS") {
                            ...
                            var allowEntityCreationProfileList = ['system admin','crm courts','pwc system admin','system administrator','system admin lex','crm ra business development','crm financial centre development', 'crm protocol', 'crm contact centre agent - protocol','crm - arbitration center'];
                            if(userInfo){
